...
Some rights are reserved as specified by Creative Commons Attribution - NonCommercial - NoDerivs version 3.0 licence, which can be accessed on

\url{https://creativecommons.org/licenses/by-nc-nd/3.0/}

\vfill

No Board Games is an international group that creates radical board games.
Check for gameplay videos on our website: \url{https://noboardgames.com}

\vfill

You are reading the version 1.0 of the rulebook, printed in English and Italian. For new
...
\section{ACKNOWLEDGEMENTS}
    ...
    Design: Matteo Modena, Ilario Gelmetti
    
    Art: Bernardo “RUPE” Anichini - IG: \texttt{@rupe\_b}
    
    Testing: Ilario Gelmetti, Matteo Modena, Matteo Paolini, Giulio Mazzocchi,Bernardo Anichini,
    Emanuele Croce, Dan Howitt, Luis Gutiérrez, Nicola Fiorillo, Loz, Riccardo Bernori,
    Luna Golino, Michele Bertoldi
    
    Communication: Matteo Paolini, Matteo Modena
    
    Video: Davide Morittu
    
    We want to thank all the backers that trusted us during the crowdfunding campaign, and
    specifically “The Boss” backers: Rock Castle, Matteo R. and Comrade Alex!
    
    Also, this game would not have been possible without the countless online testing
    sessions that were joined by many. Special thanks go to the heroic Dan Howitt and the
    unstoppable Luis Gutiérrez.
...
\section{BACKGROUND}
    ...
    *The Luddite movement was a class struggle in England during the 19th century, whereby
...
\section{OVERVIEW}
    ...
    As a worker, you must negotiate and accept Contracts from the bosses, to collect enough
    coins to pay your Rent and survive. But only a collective and coordinated strike will bring
    victory to the workers.
    
    As a boss, you control the production, the money, and therefore the workers. You must
    offer the favoured Contracts and accumulate the greatest profit before your competitor
    does.
