...
\begin{wrapfigure}[6]{R}{0.15\textwidth}
    \vspace{-0.6cm}
    \centering
    \includegraphics[height=5\baselineskip]{QR_code_BGG_forum.png}
\end{wrapfigure}
...
"Rules". Log your games on the forum "Sessions".}

\url{https://boardgamegeek.com/boardgame/357812/fully-automated-board-game/forums/}
...
\section{ACKNOWLEDGEMENTS}
    ...
    \textbf{\indent Design}: Matteo Modena, Ilario Gelmetti
