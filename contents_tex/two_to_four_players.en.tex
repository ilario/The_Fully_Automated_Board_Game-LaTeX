...
\section{NUMBER OF PLAYERS}
    ...
    \textbf{Beware!} The rules of the 2–4 \faPeopleGroup\ game are very different from the ones for 5–10 \faPeopleGroup! \textbf{Some
    cards have a text saying "2–4 \faPeopleGroup"}: the rules here are for games from 2 to 4 players. For games with 5–10 \faPeopleGroup, go to page \pageref{ch:5-10}.
...
\section{SET-UP}
	...
	\begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{setup_2_4.jpg}
	\end{figure}

    \begin{enumerate}
        \item Take a \textbf{boss card} and place it at the centre of the table. It is \textbf{automated}, it is
        therefore \textbf{not a player}.
        \item Give \textbf{each player a Prolet worker card} (red flag symbol, without any secret
        role) face up. They place it in front of them on the table.
        \item Give a \textbf{personal token} to each player. Try to find the best suited token for
        each person, so that the association will be easier to remember. Keep aside
        the hourglass token.
        \item Place the \textbf{robot cards deck} at the centre of the table.
        \item Remove the "Depression" Contracts card from the game. Or keep it in case
        you want to play a harder game. Place the deck of \textbf{Contracts cards} face
        down at the centre of the table.
        \item Place the deck of \textbf{Event cards} face down at the centre of the table. Assemble
        the Event cards deck with:
        \begin{itemize}
            \item \textbf{2 players}: 8 random Event cards
            \item \textbf{3 players}: 10 random Event cards
            \item \textbf{4 players}: all 17 Event cards
        \end{itemize}
        \item Place the \textbf{6 phase cards} (on the "2–4 \faPeopleGroup" side) face up, one next to the other,
        ...
        a piece of paper.
        \item All the workers and the automated boss start with \textbf{0 \faRubleSign\ coins each}.
    \end{enumerate}
...
\section{VICTORY CONDITIONS}
    ...
    \subsection{COLLECTIVE VICTORY}
        ...
        All players still in the game, win when they \textbf{control as many robots as there are
    ...
    \subsection{COLLECTIVE DEFEAT}
        ...
        \begin{itemize}
            \item \textbf{The automated boss has as many robots as all the players}, eliminated
            and still in play;
            \item A player should draw an Event card, but the \textbf{Events deck ran out of cards};
            \item \textbf{Half of the players are eliminated} (when playing in 3, this happens with the
            elimination of 2 \faPeopleGroup).
        \end{itemize}
    
    \subsection{CLASS BETRAYAL VICTORY}
    
        \textbf{Any non-Stressed player with 8 \faRubleSign\ coins}, or two non-Stressed players united by
...
\section{GAMEPLAY}
    ...
    The \textbf{first starting player} is the one who most recently participated in a protest
    or strike (in real life or in the game).

    \begin{itemize}
        \item \textbf{Phase 1 State-funded innovation}: the boss could buy a \textbf{robot}.
        \item \textbf{Phase 2 Event}: the starting player reveals an \textbf{Event} card and applies its effect.
        \item \textbf{Phase 3 Contracts}: the starting player reveals a \textbf{Contracts} card, and picks
        a Contract first. Clockwise, the other players choose between the remaining
        Contracts.
        \item \textbf{Phase 4 Strike}: simultaneously, non-Stressed workers reveal whether they
        will \textbf{strike or work}. Players \textbf{cannot discuss} strike intentions.
        \item \textbf{Phase 5 Payday}: players who worked get a \textbf{salary}. Robots \textbf{produce}.
        \item \textbf{Phase 6 Rent}: the players pay the \textbf{Rent} to the automated boss. The player
...
\section{Phase 1 STATE-FUNDED INNOVATION}
    ...
    \subsection{AUTOMATED BOSS ACTIONS}
        ...
        \begin{itemize}
            \item If the automated \textbf{boss has at least 15 \faRubleSign}, move 15 \faRubleSign\ to the Bank, and place
            next to the boss card a \textbf{new robot} card on the blue side.
        \end{itemize}
...
\section{Phase 2 EVENT}
    ...
    \subsection{WORKERS ACTIONS}
        ...
        \begin{itemize}
            \item The starting player must reveal an \textbf{Event card and apply} its effect. If there is
    ...
    \subsection{ADDITIONAL DETAILS AND EXAMPLES}
        ...
        \subsubsection{SYMBOLS ON THE EVENT CARDS}
            ...
            \begin{minipage}{0.07\linewidth}
                \includegraphics[width=1\textwidth]{event_card_symbol_thunder.png}
            \end{minipage}\quad
            \begin{minipage}{0.88\linewidth}
                \textbf{PLAY AND DISCARD}
            \end{minipage}

            \noindent
            \begin{minipage}{0.07\linewidth}
                \includegraphics[width=1\textwidth]{event_card_symbol_infinte.png}
            \end{minipage}\quad
            \begin{minipage}{0.88\linewidth}
                \textbf{PERMANENT EFFECT}, the affected player keeps the card
            \end{minipage}

            \noindent
            \begin{minipage}{0.07\linewidth}
                \includegraphics[width=1\textwidth]{event_card_symbol_you.png}
            \end{minipage}\quad
            \begin{minipage}{0.88\linewidth}
                This card affects the \textbf{CURRENT STARTING PLAYER}
            \end{minipage}

            \noindent
            \begin{minipage}{0.07\linewidth}
                \includegraphics[width=1\textwidth]{event_card_symbol_anyone.png}
            \end{minipage}\quad
            \begin{minipage}{0.88\linewidth}
                This card affects a \textbf{CHOSEN PLAYER}
            \end{minipage}

            \noindent
            \begin{minipage}{0.07\linewidth}
                \includegraphics[width=1\textwidth]{event_card_symbol_everyone.png}
            \end{minipage}\quad
            \begin{minipage}{0.88\linewidth}
                This card affects \textbf{MORE THAN ONE PLAYER}
            \end{minipage}

            If the unavoidable and immediate effect of an Event card is to eliminate a player,
            ignore this effect: \textbf{Event cards cannot directly eliminate players}.

        \subsubsection{EXAMPLE}

            \itsmall{The automated boss has no coins at the beginning of the game, so clearly will not buy a
...
\section{Phase 3 CONTRACTS}
    ...
    \subsection{WORKERS ACTIONS}
        ...
        \begin{itemize}
            \item The starting player must reveal a \textbf{Contracts card}, choose a Contract and
            \textbf{place the personal token} on it. The other players, in clockwise order, must
    ...
    \subsection{ADDITIONAL DETAILS AND EXAMPLES}
        ...
        \begin{itemize}
            \item \textbf{Get Stressed}: Contracts may cause Stress, this will be applied during phase
            5 Payday.
            \item \textbf{Holidays included}: in addition to the salary, Contracts may include Holidays.
            Holidays will allow players to eliminate Stress during phase 5 Payday.
            \item \textbf{Permanent Contract}: will last for more rounds, until the player accepts another
            ...
            \item A \textbf{Contracts card cannot directly eliminate a player}: if a Contract says "get
        ...
        \subsubsection{SYMBOLS ON THE CONTRACTS CARDS}
            ...
            \begin{minipage}{0.1\linewidth}
                \includegraphics[width=1\textwidth]{contracts_card_symbol_stress.jpg}
            \end{minipage}\quad
            \begin{minipage}{0.85\linewidth}
                \textbf{Get Stressed}: Contracts may cause Stress, this will be applied during
                phase 5.
            \end{minipage}

            \noindent
            \begin{minipage}{0.1\linewidth}
                \includegraphics[width=1\textwidth]{contracts_card_symbol_holidays.jpg}
            \end{minipage}\quad
            \begin{minipage}{0.85\linewidth}
                \textbf{Holidays included}: in addition to the salary, Contracts may include Holidays.
        ...
        \subsubsection{EXAMPLE}
            ...
            \itsmall{Since it's her turn to start, Bedelia draws a Contracts card, and shows it to everyone. It's the
...
\section{Phase 4 STRIKE}
    ...
    \subsection{WORKERS ACTIONS}
        ...
        \begin{itemize}
            \item All the non-eliminated \textbf{non-Stressed} players place one hand towards the
            centre of the table and, \textbf{at the same time, must vote} one of the following:
            \begin{itemize}
                \item \textbf{thumb up} = strike for \textbf{Acceleration}
                \item \textbf{closed fist} = strike for \textbf{Expropriation}
                \item \textbf{open hand} = \textbf{work}
            \end{itemize}
        \end{itemize}
Alternatively, they can write their action on a piece of paper.
    ...
    \subsection{ADDITIONAL DETAILS AND EXAMPLES}
        ...
        \begin{itemize}
            \item \textbf{Stressed players cannot strike} and so must work.
            \item \textbf{It's forbidden to talk} or communicate \textbf{about strikes}.
            \item \textbf{Acceleration Strike: every thumb raised creates one robot for the boss}.
            The boss loses all the coins earned up to that point. Beware that \textbf{more than
            ...
            \item \textbf{Expropriation Strike}: If the \textbf{majority} of players (with 2 \faPeopleGroup\ the majority is 2;
            with 3 \faPeopleGroup\ majority is 2; with 4 \faPeopleGroup\ majority is 3) voted with a closed fist, \textbf{take
        ...
        \subsubsection{EXAMPLE}
            ...
            \itsmall{After a short countdown, the 3 \faPeopleGroup\ express their decisions with their hands: Bedelia
...
\section{Phase 5 PAYDAY}
    ...
    \subsection{AUTOMATED BOSS ACTIONS}
        ...
        \begin{itemize}
            \item Each \textbf{robot} the boss controls \textbf{produces 2 \faRubleSign}\ for the boss.
        \end{itemize}
    
    \subsection{WORKERS ACTIONS}

        \begin{itemize}
            \item Each \textbf{non-striking worker} receives the \textbf{salary} and applies the \textbf{additional
            effects} from the chosen Contract. The effect of "\textbf{with Holidays}" is to remove
            the Stress, Untapping the character card. The effect of "\textbf{get Stressed}" is to
            Tap the character card (remember that a Stressed player cannot do any kind
            of strike).
            \item Each \textbf{Expropriated robot} produces \textbf{1 coin} for the worker it is assigned to.
        \end{itemize}
    ...
    \subsection{ADDITIONAL DETAILS AND EXAMPLES}
        ...
        \subsubsection{EXAMPLE}
            ...
            \itsmall{The new robot produces 2 \faRubleSign\ for the boss. Bedelia receives 3 \faRubleSign\ from the Bank, but
...
\section{Phase 6 RENT}
    ...
    \subsection{WORKERS ACTIONS}
        ...
        \begin{itemize}
            \item Unless an Event card changes this, \textbf{each worker pays 1 coin directly to the
            boss}.
        \end{itemize}
    ...
    \subsection{ADDITIONAL DETAILS AND EXAMPLES}
        ...
        \begin{itemize}
            \item A player who \textbf{can't pay the Rent gets Stressed}. \textbf{If already Stressed} and
            cannot pay the Rent, this player is considered \textbf{eliminated} and stops participating in the game.
            ...
            \item \textbf{If half of the players are eliminated, the game is over}, see collective de-
        ...
        \subsubsection{EXAMPLE}
            ...
            \itsmall{Bedelia pays her 1-coin Rent, moving one of her 3 \faRubleSign\ next to the boss card. Candida
