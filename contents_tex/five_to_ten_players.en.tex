...
\section{SET-UP}
    ...
    \begin{table}
        \centering
        \begin{tabular}{ M{0.15\textwidth} |  M{0.08\textwidth} M{0.09\textwidth} M{0.1\textwidth} M{0.08\textwidth} M{0.1\textwidth} M{0.2\textwidth}} 
            \hline
...
\section{VICTORY CONDITIONS}
    ...
    \subsection{BOSS' VICTORY}
        ...
        \begin{table}[h]
            \centering
             \begin{tabular}{ | M{0.37\textwidth} |  M{0.07\textwidth} | M{0.07\textwidth} | M{0.07\textwidth} | M{0.07\textwidth} | M{0.07\textwidth} | M{0.07\textwidth} | } 
                \hline
