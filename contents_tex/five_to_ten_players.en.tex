...
\section{NUMBER OF PLAYERS}
    ...
    cards have a text saying} "5–10 \faPeopleGroup": the rules here are for games from 5 to 10 players. For games with 2–4 \faPeopleGroup, go to page \pageref{ch:2-4}.
...
\section{SET-UP}
    ...
    \begin{table}
        \centering
        \begin{tabular}{ M{0.14\textwidth} |  M{0.08\textwidth} M{0.09\textwidth} M{0.1\textwidth} M{0.08\textwidth} M{0.1\textwidth} M{0.16\textwidth}} 
            \hline
            Number of PLAYERS & Role: Boss & Role: Prolet & Role: Startupper & Role: Scab & Role: Luddite & Jobs from PUBLIC WORK card \\ [0.5ex] 
            \hline
            \textbf{02 - 04} \faPeopleGroup \rule[-2ex]{0pt}{5.5ex}	&	\multicolumn{6}{c}{GO TO PAGE \pageref{ch:2-4} OF THIS RULEBOOK!}	\\
            \textbf{05} \faPeopleGroup \rule[-2ex]{0pt}{3.5ex} &	2	&	1	&	1	&	1	&	--	&	1	\\
            \textbf{06} \faPeopleGroup \rule[-2ex]{0pt}{3.5ex} &	2	&	1	&	1	&	1	&	1	&	1	\\
            \textbf{07} \faPeopleGroup \rule[-2ex]{0pt}{3.5ex} &	2	&	2	&	1	&	1	&	1	&	2	\\
            \textbf{08} \faPeopleGroup \rule[-2ex]{0pt}{3.5ex} &	2	&	2	&	2	&	1	&	1	&	2	\\
            \textbf{09} \faPeopleGroup \rule[-2ex]{0pt}{3.5ex} &	2	&	2	&	2	&	2	&	1	&	3	\\
            \textbf{10} \faPeopleGroup \rule[-2ex]{0pt}{3.5ex} &	2	&	2	&	3	&	2	&	1	&	3	\\ [1ex] 
            \hline
         \end{tabular}
    \end{table}
    ...
    \begin{enumerate}
        ...
        \begin{minipage}{0.125\linewidth}
            \includegraphics[width=1\textwidth]{token_1.jpg}
        \end{minipage}%
        \begin{minipage}{0.125\linewidth}
            \includegraphics[width=1\textwidth]{token_2.jpg}
        \end{minipage}%
        \begin{minipage}{0.125\linewidth}
            \includegraphics[width=1\textwidth]{token_3.jpg}
        \end{minipage}%
        \begin{minipage}{0.125\linewidth}
            \includegraphics[width=1\textwidth]{token_4.jpg}
        \end{minipage}%
        \begin{minipage}{0.125\linewidth}
            \includegraphics[width=1\textwidth]{token_5.jpg}
        \end{minipage}%
        \begin{minipage}{0.125\linewidth}
            \includegraphics[width=1\textwidth]{token_6.jpg}
        \end{minipage}%
        \begin{minipage}{0.125\linewidth}
            \includegraphics[width=1\textwidth]{token_7.jpg}
        \end{minipage}%
        \begin{minipage}{0.125\linewidth}
            \includegraphics[width=1\textwidth]{token_8.jpg}
        \end{minipage}%
	...
	\begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{setup_5_10.jpg}
	\end{figure}
...
\section{VICTORY CONDITIONS}
    ...
    \subsection{BOSS' VICTORY}
        ...
        \begin{table}[h]
            \centering
             \begin{tabular}{ | M{0.34\textwidth} |  M{0.07\textwidth} | M{0.07\textwidth} | M{0.07\textwidth} | M{0.07\textwidth} | M{0.07\textwidth} | M{0.07\textwidth} | } 
                \hline
                \faPeopleGroup\ Total number of players (workers + 2 bosses) & 5 & 6 & 7 & 8 & 9 & 10 \\ [0.5ex] 
                \hline
                Boss' victory condition (coins)	&	35 \faRubleSign	&	40 \faRubleSign	&	45 \faRubleSign	&	50 \faRubleSign	&	55 \faRubleSign	&	60 \faRubleSign	\\ [1ex] 
                 \hline
             \end{tabular}
        \end{table}
