...
% instead of preprint, you can also try /screen, /ebook and /printer
...
% po4a: command -newenvironment {}[][]{}{}
% po4a: command -newcolumntype {}[]{}
% po4a: command -MakeOuterQuote {}
% po4a: command -newcommand {}[]{}
% po4a: command -addthumb {}{}{}{}
% po4a: command -stopthumb 
% po4a: command -noindent 
% po4a: command -indent 
% po4a: command -begingroup 
% po4a: command -let 
% po4a: command -endgroup 
% po4a: command -setupTOC 
% po4a: command -hrule 
% po4a: command -titlespacing {}{}{}{}
% po4a: command selectlanguage {_}
% po4a: command -renewcommand {}{}
% po4a: environment minipageparindent {}
% po4a: environment wrapfigure []{}{}
% po4a: environment multicols {}


\input{contents_tex/latex_preamble.en.tex}

\title{\uppercase{\textbf{The Fully Automated Boardgame}}\\
    English rulebook\\
    \vspace{1ex}
    % the poster image in the title page, idea taken from here:
    % https://tex.stackexchange.com/a/551584/173645
    \includegraphics[scale=0.45]{cover.jpg}}
...
% avoid having a page break just after the ToC
\begingroup

% the common way for avoiding the newpage after the page title would be to use \let\cleardoublepage\relax but po4a cannot match it
\renewcommand{\cleardoublepage}{\relax}

% ToC on two columns
\begin{multicols}{2}
% customize title location for the ToC
    \setupTOC
    \tableofcontents
\end{multicols}
...
\input{contents_tex/introduction.en.tex}
...
\chapter{Rules for 5 to 10 players}\label{ch:5-10}
    ...
    \input{contents_tex/five_to_ten_players.en.tex}
...
\input{contents_tex/glossary.en.tex}

\input{contents_tex/rear_page.en.tex}
